...
public class NodeDistance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DLLNode<Integer> found=list.find(z);
        if(found==null){
            System.out.println(list);
            return;
        }
        ...
        if(counter-m>=0) {
            ...
            //1<->2<->3<->4<->5
            //3<->1<->2<->4<->5
            DLLNode<Integer> tmp = temp.pred;//5
            DLLNode<Integer> tmp2 = node.pred;//2
            DLLNode<Integer> tmp3 = node.succ;//4
...
//            temp.succ = tmp2;
            ...
            DLLNode<Integer> tmp = temp.succ;//11
            DLLNode<Integer> tmp2 = node.pred;//2
            DLLNode<Integer> tmp3 = node.succ;//1
