...
public class NodeDistance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DLLNode<Integer> before=node;
        DLLNode<Integer> after=node;
        ...
        for(int i=0; i<n; i++){
            ...
            counter2=0;
            for(int j=0; j<n-1; j++){
                while(before.pred!=null){
                    sum+=before.pred.element;
                    before=before.pred;
                    counter1++;
                }
                while (after.succ!=null){
                    sum1+=after.succ.element;
                    after=after.succ;
                    counter2++;
                }
            }
            prosek=sum/(double) counter1;
            prosek1=sum1/(double) counter2;
            if(prosek>prosek1){
                counter++;
            }
            node=node.succ;
