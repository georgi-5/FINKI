...
public class Solution {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            SLLNode<MapEntry<Person, Project>> entryNode = table.search(person);
            if (entryNode == null) {
                table.insert(person, project);
            } else {
                Project existingProject = entryNode.element.value;
                int existingSalary = existingProject.time * existingProject.rate;
                int newSalary = project.time * project.rate;
