    ...
    public static void main(String[] args){
        ...
        for(int i=0;i<n+q;i++){
            ...
            if(split[0].equals("insert")){
                if(i==0){
                    tree.makeRoot(Integer.parseInt(split[1]));
                }
                else{
                    while(true){
                        if (root.info>Integer.parseInt(split[1])){
                            if(root.left==null){
                                tree.addChild(root,BNode.LEFT,Integer.parseInt(split[1]));
                                break;
                            }
                            else{
                                root=root.left;
                            ...
                            if(root.right==null){
                                tree.addChild(root,BNode.RIGHT,Integer.parseInt(split[1]));
                                break;
                            }
                            else{
                                root=root.right;
